...
(SELECT dog_id FROM Dogs WHERE name = 'Borus',2025-06-10 09:30:00,'Beachside Ave','accepted')
(SELECT dog_id FROM Dogs WHERE name = 'Baxter',2025-06-10 09:30:00,'Beachside Ave','accepted')
(SELECT dog_id FROM Dogs WHERE name = 'Reggie',2025-06-10 09:30:00,'Beachside Ave','accepted');