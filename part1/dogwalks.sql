...
(SELECT dog_id FROM Dogs WHERE name = 'Baxter',2025-06-10 11:45:00,'Beachside Ave','accepted')
(SELECT dog_id FROM Dogs WHERE name = 'Reggie',2025-06-10 12:40:00,'Beachside Ave','accepted');